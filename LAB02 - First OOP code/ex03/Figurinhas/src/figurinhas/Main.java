...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        A[0].setInfoInit("Ronaldo", "1/1/2000", "Brasil", "Atacante", 1.83F, 74F);
        A[1].setInfoInit("Neymar", "1/1/2000", "Brasil", "Atacante", 1.83F, 74F);
        A[2].setInfoInit("Socrates", "1/1/2000", "Brasil", "Atacante", 1.83F, 74F);
